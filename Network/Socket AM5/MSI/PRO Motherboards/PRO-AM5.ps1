$NICDrivers = @(
    @{Name = "MSI Socket AM5 PRO Motherboard Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/MSI/PRO%20Motherboards/MSI-PROSeries-AM5-Realtek-EthernetDrivers.zip"}
)

$DriverFileNames = @(
    @{FileName = "MSI-PROSeries-AM5-Realtek-EthernetDrivers.zip"} 
)

Import-Module -Name OSD -Force
Import-Module -Name 7Zip4Powershell -Force

$destination = "C:\download\drivers\Socket AM5\MSI\PRO\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $expanddir = "C:\download\drivers\Socket AM5\MSI\PRO\Ethernet\extract"
