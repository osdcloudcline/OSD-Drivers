...
$NICDrivers = @(
    @{Name = "ASUS Socket AM5 ProArt Motherboard Ethernet Network Card Drivers 1"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASUS/ProArt%20Motherboards/ASUS-AM5-ProArt-EthernetDrivers1.zip"},
    @{Name = "ASUS Socket AM5 ProArt Motherboard Ethernet Network Card Drivers 2"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASUS/ProArt%20Motherboards/ASUS-AM5-ProArt-EthernetDrivers2.zip"}
)


$DriverFileNames = @(
    @{FileName = "ASUS-AM5-ProArt-EthernetDrivers1.zip"}, 
    @{FileName = "ASUS-AM5-ProArt-EthernetDrivers2.zip"}
)
...
foreach($Driver in $NICDrivers){
    $destination = "C:\download\drivers\Socket AM5\ASUS\ProArt\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $parentdir = "C:\download\drivers\Socket AM5\ASUS\ProArt\Ethernet"
