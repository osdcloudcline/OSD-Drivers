...
$NICDrivers = @(
    @{Name = "ASUS Socket AM5 Expedition Motherboard Ethernet Network Card Drivers 1"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASUS/Expedition%20Motherboards/ASUS-AM5-Expedition-EthernetDrivers1.zip"},
    @{Name = "ASUS Socket AM5 Expedition Motherboard Ethernet Network Card Drivers 2"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASUS/Expedition%20Motherboards/ASUS-AM5-Expedition-EthernetDrivers2.zip"}
)


$DriverFileNames = @(
    @{FileName = "ASUS-AM5-Expedition-EthernetDrivers1.zip"}, 
    @{FileName = "ASUS-AM5-Expedition-EthernetDrivers2.zip"}
)
...
foreach($Driver in $NICDrivers){
    $destination = "C:\download\drivers\Socket AM5\ASUS\Expedition\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $parentdir = "C:\download\drivers\Socket AM5\ASUS\Expedition\Ethernet"
