$NICDrivers = @(
    @{Name = "ASRock Socket AM5 Steel Legend Motherboard Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASRock/Steel%20Legend%20Motherboards/ASRock-AM5-SteelLegend-EthernetDrivers.zip"}
)

$DriverFileNames = @(
    @{FileName = "ASRock-AM5-SteelLegend-EthernetDrivers.zip"} 
)

Import-Module -Name OSD -Force
Import-Module -Name 7Zip4Powershell -Force

$destination = "C:\download\drivers\Socket AM5\ASRock\Steel Legend\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $expanddir = "C:\download\drivers\Socket AM5\ASRock\Steel Legend\Ethernet\extract"
