$NICDrivers = @(
    @{Name = "ASRock Socket AM5 PRO Motherboard Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/ASRock/PRO%20Motherboards/ASRock-AM5-PRO-EthernetDrivers.zip"}
)

$DriverFileNames = @(
    @{FileName = "ASRock-AM5-PRO-EthernetDrivers.zip"} 
)

Import-Module -Name OSD -Force
Import-Module -Name 7Zip4Powershell -Force

$destination = "C:\download\drivers\Socket AM5\ASRock\PRO\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $expanddir = "C:\download\drivers\Socket AM5\ASRock\PRO\Ethernet\extract"
