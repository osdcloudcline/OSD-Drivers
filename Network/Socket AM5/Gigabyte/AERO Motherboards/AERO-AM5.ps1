$NICDrivers = @(
    @{Name = "Gigabyte Socket AM5 AERO Motherboard Intel Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM5/Gigabyte/AERO%20Motherboards/Gigabyte-AM5-AERO-EthernetDriver.zip"}
)
...
$destination = "C:\download\drivers\Socket AM5\Gigabyte\AERO\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $expanddir = "C:\download\drivers\Socket AM5\Gigabyte\AERO\Ethernet\extract"
