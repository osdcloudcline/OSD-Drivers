$NICDrivers = @(
    @{Name = "ASUS Socket AM4 CSM Motherboard Intel Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM4/Desktop%20Motherboards/ASUS/CSM%20Motherboards/Intel-I211-LANDrivers.zip"}
)

$DriverFileNames = @(
    @{FileName = "Intel-I211-LANDrivers.zip"} 
)
