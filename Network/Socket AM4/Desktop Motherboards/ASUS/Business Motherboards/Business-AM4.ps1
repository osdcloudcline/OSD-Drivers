...
$NICDrivers = @(
    @{Name = "ASUS Socket AM4 Business Motherboard Ethernet Network Card Drivers 1"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM4/Desktop%20Motherboards/ASUS/Business%20Motherboards/Realtek-LANDrivers.zip"},
    @{Name = "ASUS Socket AM4 Business Motherboard Ethernet Network Card Drivers 2"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM4/Desktop%20Motherboards/ASUS/Business%20Motherboards/Realtek-LANDrivers-2.zip"}
)
...
foreach($Driver in $NICDrivers){
    $destination = "C:\download\drivers\Socket AM4\ASUS\Business\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $parentdir = "C:\download\drivers\Socket AM4\ASUS\Business\Ethernet"
