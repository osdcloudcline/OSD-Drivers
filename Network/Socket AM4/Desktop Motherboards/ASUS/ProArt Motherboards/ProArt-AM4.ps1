$NICDrivers = @(
    @{Name = "ASUS Socket AM4 ProArt Motherboard Intel Ethernet Network Card Drivers"; DriverFileURL = "https://github.com/osdcloudcline/OSD-Drivers/raw/refs/heads/main/Network/Socket%20AM4/Desktop%20Motherboards/ASUS/ProArt%20Motherboards/ProArt-LANDriver.zip"}
)

$DriverFileNames = @(
    @{FileName = "ProArt-LANDriver.zip"} 
)

Import-Module -Name OSD -Force
Import-Module -Name 7Zip4Powershell -Force

$destination = "C:\download\drivers\Socket AM4\ASUS\ProArt\Ethernet"
...
foreach($FileItem in $DriverFileNames){
    $expanddir = "C:\download\drivers\Socket AM4\ASUS\ProArt\Ethernet\extract"
